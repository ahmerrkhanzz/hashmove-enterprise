...
import { getImagePath, ImageSource, ImageRequiredSize, getDateDiff, encryptBookingID, Tea, getProviderImage } from '../../../constants/globalfunctions';
...
@Component({
  selector: 'special-booking-card',
  templateUrl: './special-request-card.component.html',
  styleUrls: ['./special-request-card.component.scss']
})
export class SpecialRequestCardComponent implements OnInit {
  @Input() bookings: any
